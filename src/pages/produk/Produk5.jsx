...
function Produk5() {
  ...
  return (
    <div className="container shadow view-produk">
      <div className="row">
        <div className="col">
          <h5 className="fw-bold mb-5">{semuaProduk[4].label}</h5>
          <img src={semuaProduk[4].image} alt="" />
        </div>
        <div className="col mt-5">
          <h2 className="fs-4 fw-bold mb-2">{semuaProduk[4].title}</h2>
          <div className="d-inline">
            <i className={semuaProduk[4].star1}></i>
            <i className={semuaProduk[4].star1}></i>
            <i className={semuaProduk[4].star1}></i>
            <i className={semuaProduk[4].star1}></i>
            <i className={semuaProduk[4].star5}></i>
            <span className="ms-2">{semuaProduk[4].rate}</span>
          </div>
          <div className="containerHarga">
            {semuaProduk[4].price}
            <div className="fs-5 d-flex desc mt-2">
              <i className={semuaProduk[4].diskon.icon}></i>
              <p className="ms-3">{semuaProduk[4].diskon.desc}</p>
            </div>
            <div className="fs-5 d-flex desc">
              <i className={semuaProduk[4].diskon.icon2}></i>
              <p className="ms-3">{semuaProduk[4].diskon.desc2}</p>
            </div>
            <div className="fs-5 d-flex desc">
              <i className={semuaProduk[4].diskon.icon3}></i>
              <p className="ms-3">{semuaProduk[4].diskon.desc3}</p>
            </div>
          </div>
          <p className="text-secondary fw-bold">Deskripsi Produk:</p>
          <p>{semuaProduk[4].desc}</p>
